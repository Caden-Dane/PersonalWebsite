  ...
  const posts = [
    {
      ...
      excerpt: 'Exploring emerging frameworks and paradigms that are shaping the next generation of web applications. From server components to edge computing, the landscape is evolving rapidly.',
      date: '2024-01-15',
      readTime: '8 min read',
    ...
    {
      id: 2,
      title: 'Design Systems That Scale: Lessons from Building at Startup Speed',
      excerpt: 'How we built a comprehensive design system that could adapt to rapid product changes while maintaining consistency across multiple platforms.',
      date: '2024-01-08',
      readTime: '6 min read',
      tags: ['Design Systems', 'UI/UX', 'Startups'],
      image: 'https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=600',
      featured: false,
    },
    {
      id: 3,
      title: 'The Art of Code Reviews: Building Better Teams Through Feedback',
      excerpt: 'Code reviews are more than bug catching—they\'re opportunities for learning, knowledge sharing, and building stronger development teams.',
      date: '2023-12-22',
      readTime: '5 min read',
      tags: ['Development', 'Team Culture', 'Best Practices'],
      image: 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=600',
      featured: false,
    },
    {
      id: 4,
      title: 'Accessibility First: Making the Web Inclusive by Default',
      excerpt: 'Why accessibility shouldn\'t be an afterthought and practical strategies for building inclusive digital experiences from day one.',
      date: '2023-12-10',
      readTime: '7 min read',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Sharing insights, lessons learned, and perspectives on technology, design, and building great digital experiences.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {otherPosts.map(post => (
            <article key={post.id} className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
        ...
        <div className="mt-20 bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Get notified when I publish new thoughts on technology, design, and building great digital experiences.
          </p>
