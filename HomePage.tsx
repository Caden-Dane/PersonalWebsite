            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-slate-600 leading-relaxed">
                  Passionate about building beautiful, functional experiences that bridge the gap between 
                  design and technology. I craft digital solutions that not only work flawlessly but 
      ...
      <section className="py-20 px-6 bg-white/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-800 mb-4">What I Bring to the Table</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              A unique blend of technical expertise and creative vision to deliver exceptional results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-3">Creative Design</h3>
              <p className="text-slate-600">
                Crafting visually stunning interfaces that balance aesthetics with usability, ensuring every pixel serves a purpose.
              </p>
            </div>
            ...
            <div className="group p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-3">Performance Focus</h3>
              <p className="text-slate-600">
                Building fast, responsive applications that provide seamless user experiences across all devices and platforms.
              </p>
            </div>
            ...
            <div className="group p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-slate-600">
                Staying at the forefront of technology trends and implementing cutting-edge solutions that drive business success.
              </p>
            </div>
          </div>
        </div>
